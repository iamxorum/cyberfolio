export default function ThreatFeedUnavailable() {
  return (
    <div className="animate-fade-in-fast flex flex-col items-center justify-center gap-2 px-4 py-10 mb-8 border border-[var(--terminal-border)] rounded bg-[rgba(var(--terminal-bg-rgb),0.60)] text-center font-mono">
